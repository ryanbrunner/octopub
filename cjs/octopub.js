...
(function() {
  this.JST || (this.JST = {});
  this.JST["templates/app_view"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="row-fluid">\n  <div class="span2">\n    <ul class="nav nav-pills nav-stacked" id=\'side-nav\'>\n      <li><a href="#" id=\'posts\'>Posts</a></li>\n      <li><a href="#" id=\'pages\'>Pages</a></li>\n    </ul>\n  </div>\n  <div class="span10" id=\'details-pane\'>\n    <h1>Let\'s get started!</h1>\n    <p class=\'lead\'>\n      Octopub allows you to manage your <strong>pages</strong> and <strong>posts</strong>.\n      Choose one of the options at the side to view your current pages and posts, or \n      add a new page or post from the navbar at the top.\n    </p>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() {
  this.JST || (this.JST = {});
  this.JST["templates/login_view"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<header>\n  <h1>Welcome to Octopub.</h1>\n  <p class=\'lead\'>Octopub makes it easy to manage your posts and pages on GitHub Pages, even if you don\'t know Git.</p>\n</header>\n\n<form class=\'form-horizontal well\'>\n  <fieldset>\n    <legend>Login to GitHub to get started.</legend>\n    <div class=\'control-group\'>\n      <label class=\'control-label\'>GitHub UserName</label>\n      <div class=\'controls\'>\n        <input type=\'text\' name=\'username\' />\n      </div>\n    </div>\n\n    <div class=\'control-group\'>\n      <label class=\'control-label\'>Password</label>\n      <div class=\'controls\'>\n        <input type=\'password\' name=\'password\' />\n        <p class=\'help-block\'>Don\'t worry, this information is <strong>only</strong> sent to GitHub.</p>\n      </div>\n    </div>\n\n    <div class=\'control-group\'>\n      <label class=\'control-label\'>Repository to Edit</label>\n      <div class=\'controls\'>\n        <input type=\'text\' name=\'repo\' />\n      </div>\n    </div>\n\n    <div class=\'form-actions\'>\n      <input type=\'submit\' class=\'btn btn-primary\' value="Let\'s go!" />\n    </div>\n  </fieldset>\n</form>\n');}return __p.join('');};
}).call(this);
(function() {
  this.JST || (this.JST = {});
  this.JST["templates/page"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<li>\n  <h4>\n    <a class=\'edit-page\'>', page.escape('name') ,'</a>\n    \n      '); if (page.get('state') == 'new') { __p.push('\n        <span class=\'label label-warning\'>New</span>\n      '); } else if (page.get('state') == 'changed') { __p.push('\n        <span class=\'label label-warning\'>Changed</span>\n      '); } else { __p.push('\n        <span class=\'label label-success\'>Published</span>\n      '); } __p.push('\n  </h4>\n  <div>Last Updated on: ', page.escape('updated_at') ,'</h4>\n</li>\n');}return __p.join('');};
}).call(this);
(function() {
  this.JST || (this.JST = {});
  this.JST["templates/pages_list"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<header>\n  <h1>Pages</h1>\n  <p class=\'lead\'>\n    Click on any page below to preview or make changes. When you\'re satisfied with all your changes,\n    click \'Publish\' to push changes up to your GitHub site.\n  </p>\n\n  <ul class=\'unstyled list well\'>\n  '); collection.each(function(page) { __p.push('\n    ', JST['templates/page']({page: page}) ,'\n  '); }); __p.push('\n  </ul>\n');}return __p.join('');};
}).call(this);
...
// Base App includes - where order is important
